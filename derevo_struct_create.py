...
def generate_tree(dir_path, max_depth, current_depth=0, prefix="", exclude=None):
    if exclude is None:
        exclude = {"__pycache__", ".git", ".idea", ".venv", ".gitignore", ".gitattributes"}
...
papka_project = "C:/Users/Саша/Documents/GitHub/FlowerDeliveryMast/flower_delivery"  # Замените на путь к вашей папке
file_out = "C:/Users/Саша/Documents/GitHub/FlowerDeliveryMast/for_readme.md"  # Замените на путь к выходному файлу
urovni = 4  # Максимальный уровень вложенности
